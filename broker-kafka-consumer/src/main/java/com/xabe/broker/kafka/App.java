package com.xabe.broker.kafka;

import com.xabe.broker.kafka.config.CustomResourceConfig;
import com.xabe.broker.kafka.config.spring.SpringConfig;
...
public class App {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        server = GrizzlyHttpServerFactory.createHttpServer(URI.create(getUriInfo("http" ,8011)), rc,false);
